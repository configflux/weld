"""Acceptance tests for cortex brief — JSON contract and ranking behavior.
...
from cortex.brief import BRIEF_VERSION, brief  # noqa: E402
from cortex.brief import main as brief_main  # noqa: E402
...
class BriefCliAcceptanceTest(unittest.TestCase):
    ...
    def _setup_graph(self, nodes: dict, edges: list | None = None) -> str:
        ...
        (cortex_dir / "graph.json").write_text(
