"""v2 tests for cortex brief -- interfaces bucket and interaction-aware ranking.

Split from ``cortex_brief_test.py`` to keep that file under the 400-line lint
cap while v1 coverage stays intact. The v1 classification/ranking/limit
tests remain in ``cortex_brief_test.py``; this module owns the contract that
...
from cortex.brief import _classify_node, brief  # noqa: E402
