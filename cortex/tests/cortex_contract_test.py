"""Tests for the cortex normalized metadata contract and graph validation.

ROS2-vocabulary tests for project-f7y.3 live in cortex_contract_ros2_test.py.
"""
...
from cortex.contract import VALID_EDGE_TYPES, VALID_NODE_TYPES  # noqa: E402
