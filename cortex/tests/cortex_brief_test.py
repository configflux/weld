"""Tests for cortex brief — stable JSON output contract and ranking behavior."""
...
from cortex.brief import (  # noqa: E402
    BRIEF_VERSION,
    _classify_node,
    _sort_key,
    brief,
...
class BriefClassificationTest(unittest.TestCase):
    ...
    # in cortex_brief_v2_test.py to keep this file under the 400-line lint cap.
