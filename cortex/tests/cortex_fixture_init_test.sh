...
# cortex_fixture_init_test: validates cortex init against polyglot fixture repos.
#
# Tests cortex init on four fixture repository shapes:
...
profiles = {}
for name, path in [
    ('python_bazel', '${TMPDIR}/python_bazel/.cortex/discover.yaml'),
    ('typescript_node', '${TMPDIR}/typescript_node/.cortex/discover.yaml'),
    ('cpp_clang', '${TMPDIR}/cpp_clang/.cortex/discover.yaml'),
    ('legacy_onboarding', '${TMPDIR}/legacy_onboarding/.cortex/discover.yaml'),
]:
...
echo "PASS: all kg_fixture_init tests passed"
