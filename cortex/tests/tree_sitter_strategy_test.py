...
class QueryFileLoadingTest(unittest.TestCase):
    """Query YAML files in cortex/languages/ must be loadable and validated."""
    ...
    def test_malformed_query_file_raises(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            with mock.patch(
                "cortex.strategies.tree_sitter._languages_dir",
...
class TreeSitter025ApiTest(unittest.TestCase):
    ...
    def _run_with_mock_ts(
        ...
        from cortex.strategies import tree_sitter as ts_mod
