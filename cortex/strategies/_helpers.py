"""Shared helpers for cortex strategy modules.
...
from cortex import repo_boundary as _repo_boundary
...
# ---------------------------------------------------------------------------
# Shared exclusion policy — directories that must never appear in Cortex discovery
# results or the file index.  This is the single source of truth; both
# ``cortex.discover`` (via strategies) and ``cortex.file_index`` import from here.
# ---------------------------------------------------------------------------
