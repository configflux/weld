...
The callsite half lives in :mod:`cortex.strategies.events_callsite`; the
facade in :mod:`cortex.strategies.events` dispatches between the two based
...
#
# We parse line-by-line rather than importing PyYAML: the cortex helpers
