#!/usr/bin/env python3
"""Template: external adapter command for Weld discovery.
...
How it works:
  - ``wd discover`` runs the command with ``cwd`` set to the repo root.
  ...
  - The output is validated against the weld fragment contract before
