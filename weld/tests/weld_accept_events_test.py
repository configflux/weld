"""Acceptance tests for event/channel interaction graph extraction (tracked project).
...
from weld.strategies.events_bindings import extract as bindings_extract  # noqa: E402
