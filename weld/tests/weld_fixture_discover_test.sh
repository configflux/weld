...
# weld_fixture_discover_test: validates wd discover against fixture repos.
#
...
discover_fixture() {
  ...
  # Copy the fixture to a writable temp directory so we can create .weld/ there.
  ...
  # Run discover against the temp copy (which now has .weld/discover.yaml)
...
echo "PASS: all weld_fixture_discover tests passed"
